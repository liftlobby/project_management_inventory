	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
	   	...
	   	for (var x = 0; x < quantity.length; x++) {       
		    ...
		    if(quantity[x].value == ''){0264	    	
		    	$("#"+quantityId+"").after('<p class="text-danger"> Product Name Field is required!! </p>');
		    	$("#"+quantityId+"").closest('.form-group').addClass('has-error');0264	    		    		    	
	      } else {      	
		    	$("#"+quantityId+"").closest('.form-group').addClass('has-success');0264	    		    		    		    	
	      } 
	   	}  // for
		...
		$("#editOrderForm").unbind('submit').bind('submit', function() {
		    ...
		    if(productName[x].value == ''){0264	    		    	
		    	$("#"+productNameId+"").after('<p class="text-danger"> Product Name Field is required!! </p>');
		    	$("#"+productNameId+"").closest('.form-group').addClass('has-error');0264	    		    		    	
	      } else {      	
		    	$("#"+productNameId+"").closest('.form-group').addClass('has-success');0264	    		    		    	
	      }          
	   	} // for
